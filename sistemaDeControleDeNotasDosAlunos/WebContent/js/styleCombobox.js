 ...
 */
/*
 * styleCombobox 1.0 - Grifo http://www.grifotecnologia.com.br/ Date: 2010
 */
...
(function($) {
	...
	$.fn.extend({
		...
		styleCombobox : function(options) {
			...
			$selector
					.each(function() {
						var $combo = $(this), initialValue = $combo
								.attr("title") ? $combo.attr("title") : $combo
								.find("option:selected").text();

						$combo.css("position", "relative").before(
